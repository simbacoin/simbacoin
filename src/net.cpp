...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Simbacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"simbacointools.com", "dnsseed.simbacointools.com"},
    {"simbacoinpool.org", "dnsseed.simbacoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"simbacointools.com", "testnet-seed.simbacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Simbacoin is probably already running."), addrBind.ToString().c_str());
        else
